...
namespace BTL_WinForm_Ailatrieuphu
{
    public partial class FormDangNhap : Form
    {
        ...
        private void btnDangNhap_Click(object sender, EventArgs e)
        {
            try
            {
                bool KiemTraDangNhap = layer02.Kiemtradangnhap(txtTaikhoan.Text.Trim(), txtMatkhau.Text.Trim());
                int ChucNang = layer02.ChucNangNguoiDung(txtTaikhoan.Text.Trim(), txtMatkhau.Text.Trim());
